...
describe('Test suite for procedures list', () => {
  it('should return resultSet if exists', () => {
    expect(timeFormat('2015-02-23T00:11:02.518+02:00'))
      .toEqual('2015-02-23 00:11:02');
    expect(timeFormat('2015-02-23 00:11:02'))
      .toEqual('2015-02-23 00:11:02');
    expect(timeFormat('2015-02-23'))
      .toEqual('2015-02-23');
    expect(timeFormat('00:11:02'))
      .toEqual('00:11:02');
  });
  ...
  it('should successfully process a sample response from the server', () => {
    ...
    expect(proceduresCallbackProcessing(fromServer))
