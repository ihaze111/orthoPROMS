import { labOrdersCallbackProcessing, formatContextTime, formatTiming } from "../components/Queries/getLabOrdersListByEHRId";

describe('Test suite for lab orders list', () => {
it('should return resultSet if exists', () => {
    expect(formatContextTime('2015-02-23T00:11:02.518+02:00')).toEqual('2015-02-23 00:11:02');
    expect(formatContextTime('2015-02-23 00:11:02')).toEqual('2015-02-23 00:11:02');
    expect(formatContextTime('2015-02-23')).toEqual('2015-02-23');
    expect(formatContextTime('00:11:02')).toEqual('00:11:02');
});

it('should return timing format correctly', () => {
    expect(formatTiming('R5/2015-07-23T00:19:00+02:00/P2M')).toEqual('2015-07-23 00:19:00');
});
...
it('should successfully process a sample response from the server',() => {
    ...
    expect(labOrdersCallbackProcessing(fromServer)).toEqual(postProcessing);
});
});