...
/**
 * A generalized Horizontal Bar Chart - AbstractGraphs based on an array of categories and its
 * values in array, Takes: id string, labels array, data array, title string
 */
