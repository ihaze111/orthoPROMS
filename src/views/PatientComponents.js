...
function PatientProgressTableEntry(props) {
  ...
  return (
    <tr key={"composition" + props.nhs_number + "no" + props.index}>
      <td
        key={
          "composition" + props.nhs_number + "no" + props.index + "nhsNumber"
        }
      >
        {props.nhs_number}
      </td>
      <td
        key={
          "composition" + props.nhs_number + "no" + props.index + "composerName"
        }
      >
        {props.composer_name}
      </td>
      ...
      <td
        key={
          "composition" + props.nhs_number + "no" + props.index + "aofasComment"
        }
      >
        {props.aofas_comment}
      </td>
...
export function EpisodeScoresGraph(props) {
  if (props.ehrId) {
    return (
      <div>
        <EpisodeScores ehrId={props.ehrId} />
      </div>
    );
  } else {
    return null;
...
export function RespirationGraph(props) {
  if (props.ehrId) {
    return (
      <div>
        <RespirationRate ehrId={props.ehrId} />
      </div>
    );
  } else {
    return null;
...
export function PressureGraph(props) {
  if (props.ehrId) {
    return (
      <div>
        <BloodPressure ehrId={props.ehrId} />
      </div>
    );
  } else {
    return null;
...
export function OxygenConcentrationGraph(props) {
  if (props.ehrId) {
    return (
      <div>
        <IndirectOximetry ehrId={props.ehrId} />
      </div>
    );
  } else {
    return null;
