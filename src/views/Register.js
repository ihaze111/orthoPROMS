                    ...
                    <Row>
                        <Col>
                            <Form.Group controlId="formBasicCode">
                                ...
                                <Form.Control type="text" placeholder="Enter Code" name="code" onChange={ this.onChange } />
                            </Form.Group>
                        </Col>
                        <Col >
                            <Button variant="outline-primary" block style={{'margin-top': '32px'}} onClick={this.handleClick} disabled={this.state.discodeBtn}>{this.state.btnText}</Button>
                        </Col>
                    </Row>
                    <Row>
                        <Col>
                    ...
                    <Row>
                        <Col>
                            <Form.Group controlId="formBasicPassword">
                                ...
                                <Form.Control type="password" placeholder="Password" name="passwordConfirmation" onChange={ this.onChange }/>
                            </Form.Group>
                        </Col>
                    </Row>
