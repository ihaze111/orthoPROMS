...
function PatientRecordsInfo(props) {
    return <div style={{ width: "100%", display: "flex" }} className="sinfo">
        ...
        <img src="https://upload.wikimedia.org/wikipedia/commons/5/5f/User_with_smile.svg" style={{ width: "40%" }}
             alt=""></img>
    </div>;
}
					...
					<Card>
						...
						<Card.Body>
							...
							<div style={{ display: 'flex' }}>
								<div style={{ width: '36%' }}>
									<p style={{ marginBottom: '40px' }}><a href="javascript:;"
																		   className="btn btn-primary btn-lg info">Information</a>
									</p>
									<p style={{ marginBottom: '40px' }}><a href="javascript:;"
																		   className="btn btn-primary btn-lg detail">Patient
										Progress</a></p>
									<p><a href="javascript:;" className="btn btn-primary btn-lg report">Report</a></p>
								</div>
											...
											<Card>
                        						...
                        						<Accordion.Collapse eventKey="0">
													<Card.Body>
														...
														<a href="javascript:;" className="btn btn-secondary btn-lg bloodSugar" style={{backgroundColor: 'gray', opacity: '0.8'}}>Blood Sugar Levels</a>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;											
														<a href="javascript:;" className="btn btn-secondary btn-lg tendonReflex" style={{backgroundColor: 'gray', opacity: '0.8'}}>Tendon Reflexes</a>
														{/* &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<a href="javascript:;" className="btn btn-secondary btn-lg bmi" style={{backgroundColor: 'red', opacity: '0.8'}}>Body-Mass Index</a> */}
														</p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<a href="javascript:;" className="btn btn-secondary btn-lg metaRate" style={{backgroundColor: 'gray', opacity: '0.8'}}>Basal Metabolic Rate</a>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<a href="javascript:;" className="btn btn-secondary btn-lg bodyComposition" style={{backgroundColor: 'gray', opacity: '0.8'}}>Body Composition</a>
														&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
														<a href="javascript:;" className="btn btn-secondary btn-lg bodyTemp" style={{backgroundColor: 'gray', opacity: '0.8'}}>Body Temperature</a>
								...
								<div style={{ width: '90%', display: 'flex' }} className="sreport">
									<PatientRecordsReport content={<div><p>Initial treatment for a broken leg usually begins in an emergency room or
